...
public class JsHintQualitySensor extends ReportSensor<QualityReport> {
	...
	public JsHintQualitySensor(JsHintQualityConstants constants, Settings settings, RuleFinder ruleFinder, FileSystem filesystem, ResourcePerspectives resourcePerspective) {
