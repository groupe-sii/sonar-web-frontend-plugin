...
public class JsQualitySensor extends ReportSensor<QualityReport> {
	...
	public JsQualitySensor(JsQualityConstants constants, Settings settings, RuleFinder ruleFinder, FileSystem filesystem, ResourcePerspectives resourcePerspective) {
