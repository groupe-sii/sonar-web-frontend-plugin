 ...
 *
 */
public class ScssQualitySensor extends ReportSensor<QualityReport> {

	public ScssQualitySensor(ScssQualityConstants constants, Settings settings, RuleFinder ruleFinder, FileSystem filesystem, ResourcePerspectives resourcePerspective) {
