	...
	public ScsslintRuleRepository() {
		super(new WithCustomStyles(
				new WithHtmlDescription(
						new JsonFileRuleRepository(ScssQualityConstants.REPOSITORY_KEY, 
													ScssQualityConstants.LANGUAGE_KEY, 
													ScssQualityConstants.REPOSITORY_NAME, 
													ScsslintRuleRepository.class.getResourceAsStream(ScssQualityConstants.RULES_PATH)))));
	}
