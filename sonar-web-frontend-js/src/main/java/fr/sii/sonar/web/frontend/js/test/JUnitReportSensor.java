...
public class JUnitReportSensor extends ReportSensor<TestReport> {
	...
	public JUnitReportSensor(JUnitConstants constants, Settings settings, RuleFinder ruleFinder, FileSystem filesystem, ResourcePerspectives resourcePerspective) {
