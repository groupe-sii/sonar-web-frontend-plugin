...
public class HtmlQualitySensor extends ReportSensor<QualityReport> {
	...
	public HtmlQualitySensor(HtmlQualityConstants constants, Settings settings, RuleFinder ruleFinder, FileSystem filesystem, ResourcePerspectives resourcePerspective) {
