...
public class HtmlDuplicationSensor extends ReportSensor<DuplicationReport> {
	...
	public HtmlDuplicationSensor(HtmlDuplicationConstants constants, Settings settings, RuleFinder ruleFinder, FileSystem filesystem, ResourcePerspectives resourcePerspective) {
