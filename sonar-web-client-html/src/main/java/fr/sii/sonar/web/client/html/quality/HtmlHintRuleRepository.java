	...
	public HtmlHintRuleRepository() {
		super(new WithCustomStyles(
				new WithHtmlDescription(
						new JsonFileRuleRepository(HtmlQualityConstants.REPOSITORY_KEY, 
													HtmlQualityConstants.LANGUAGE_KEY, 
													HtmlQualityConstants.REPOSITORY_NAME, 
													HtmlHintRuleRepository.class.getResourceAsStream(HtmlQualityConstants.RULES_PATH)))));
	}
