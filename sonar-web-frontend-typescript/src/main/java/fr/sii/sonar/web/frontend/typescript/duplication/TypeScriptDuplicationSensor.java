 ...
 *
 */
public class TypeScriptDuplicationSensor extends ReportSensor<DuplicationReport> {

	@SuppressWarnings({ "unchecked" })
	public TypeScriptDuplicationSensor(TypeScriptDuplicationConstants constants, PluginDependencies pluginDependencies) {
