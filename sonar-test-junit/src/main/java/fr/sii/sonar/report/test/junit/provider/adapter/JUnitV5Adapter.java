...
import fr.sii.sonar.test.junit.domain.v5.Error;
import fr.sii.sonar.test.junit.domain.v5.Failure;
import fr.sii.sonar.test.junit.domain.v5.Skipped;
import fr.sii.sonar.test.junit.domain.v5.Testcase;
import fr.sii.sonar.test.junit.domain.v5.Testsuite;
import fr.sii.sonar.test.junit.domain.v5.Testsuites;

public class JUnitV5Adapter implements JUnitAdapter<Testsuites> {
