 ...
 *
 */
public class CssQualitySensor extends ReportSensor<QualityReport> {

	public CssQualitySensor(CssQualityConstants constants, Settings settings, RuleFinder ruleFinder, FileSystem filesystem, ResourcePerspectives resourcePerspective) {
