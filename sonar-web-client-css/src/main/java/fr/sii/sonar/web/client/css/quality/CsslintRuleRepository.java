...
public class CsslintRuleRepository extends WithDefaultRuleRepository {
	...
	public CsslintRuleRepository() {
		super(new WithHtmlDescription(new JsonFileRuleRepository(CssQualityConstants.REPOSITORY_KEY, CssQualityConstants.LANGUAGE_KEY, CssQualityConstants.REPOSITORY_NAME, CsslintRuleRepository.class.getResourceAsStream(CssQualityConstants.RULES_PATH))));
	}
