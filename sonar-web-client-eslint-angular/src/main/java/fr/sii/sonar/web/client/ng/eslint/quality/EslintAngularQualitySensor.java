...
public class EslintAngularQualitySensor extends ReportSensor<QualityReport> {
	...
	public EslintAngularQualitySensor(EslintAngularQualityConstants constants, Settings settings, RuleFinder ruleFinder, ModuleFileSystem filesystem, ResourcePerspectives resourcePerspective) {
